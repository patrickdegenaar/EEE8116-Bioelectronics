...
saveDirectory       = 'F:/OneDrive_files/Newcastle University/Neuroprosthesis lab - General/Code - Python/Teaching simulations/RateCoding.gif'
...
AP_threshold        = 10                # Threshold for the action potential
